...
func (c Config) FromDB(dbCfg sqlc.Config) Config {
	return Config{
		...
		CleanupIntervalHrs: int(dbCfg.CleanupIntervalHours.Int64),
		BatchSize:          int(dbCfg.BatchSize.Int64),
		LogLevel:           dbCfg.LogLevel.String,
		UpdatedAt:          dbCfg.UpdatedAt.Time,
	}
}
...
func (c Config) ToUpdateParams() sqlc.UpdateConfigParams {
	return sqlc.UpdateConfigParams{
		...
		CleanupIntervalHours: sql.NullInt64{Int64: int64(c.CleanupIntervalHrs), Valid: c.CleanupIntervalHrs > 0},
		BatchSize:            sql.NullInt64{Int64: int64(c.BatchSize), Valid: c.BatchSize > 0},
